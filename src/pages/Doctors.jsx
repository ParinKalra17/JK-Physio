    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          height: '220px',
          borderRadius: '50%',
          background: 'rgba(219,38,29,0.08)',
        }} />
        <div style={{
          position: 'absolute',
          top: '20px',
          ...
          height: '160px',
          borderRadius: '50%',
          background: 'rgba(219,38,29,0.05)',
        }} />
        ...
        <div style={{
          ...
          right: 0,
          height: '80px',
          background: 'linear-gradient(to top, rgba(219,38,29,0.18), transparent)',
          zIndex: 1,
        }} />
          ...
          >
            <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
              <path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"
                stroke="#db261d" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <style>{`
          .photo-hover-overlay:hover { background: rgba(0,0,0,0.18) !important; }
          .photo-hover-overlay:hover .camera-icon { opacity: 1 !important; }
        `}</style>
      </div>
      ...
      <div style={{
        flex: 1,
        padding: isMobile ? '24px 20px 28px' : '36px 36px 32px',
        display: 'flex',
        flexDirection: 'column',
        gap: '0px',
        overflowY: 'auto',
        ...
        <div style={{
          ...
          <span style={{ fontSize: '12px', fontWeight: '700', color: '#db261d' }}>
        ...
        <button
          ...
          style={{
            ...
            padding: '13px 16px',
            borderRadius: '14px',
            border: `1px solid ${expanded ? '#fecaca' : '#f1f5f9'}`,
            background: expanded ? '#fff5f5' : '#fafafa',
            cursor: 'pointer',
            transition: 'all 0.2s',
        ...
        >
          ...
          <svg
            width="15" height="15" fill="none" viewBox="0 0 16 16"
            ...
            {doctor.qualifications.map((q, i) => (
              ...
              >
                <div style={{
                  ...
                  height: '42px',
                  borderRadius: '10px',
                  background: 'linear-gradient(135deg, #db261d, #b91c1c)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  color: 'white',
                ...
                <div>
                  ...
                  <div style={{ fontSize: '11.5px', color: '#db261d', fontWeight: '600', marginTop: '4px' }}>
                    Class of {q.year}
                  </div>
                </div>
              </div>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div
              className="inline-block text-xs font-bold tracking-widest uppercase px-4 py-2 rounded-full mt-3"
              style={{ background: '#fee2e2', color: '#db261d' }}
            >
              Our Team
            </div>
          </div>
